...
export interface ProjectData {
  ...
  isLandmark?: boolean;
  order?: number;
  priority?: number;       // explicit sort position within same category
}
...
export const allProjects: ProjectData[] = [
  ...
  },
  {
    ...
    year: "2024",
    image: chb1,
    gallery: [chb1, chb5, chb3, chb2, chb4, chb6],
  ...
  },
  {
    ...
    year: "2024",
    image: pgi1,
    gallery: [pgi1, pgi2, pgi8, pgi13, pgi3, pgi9, pgi7, pgi12, pgi14, pgi6, pgi10, pgi11, pgi5, pgi4],
